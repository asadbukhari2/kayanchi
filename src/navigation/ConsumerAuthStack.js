  ...
  render() {
    return (
      <Stack.Navigator
        ...
        <Stack.Screen name="ConsumerNumberSignUp" component={ConsumerNumberSignUp} />
        <Stack.Screen name="ConsumerEmailSignUp" component={ConsumerEmailSignUp} />
        <Stack.Screen name="ConsumerOtpSignUp" component={ConsumerOtpSignUp} />
        <Stack.Screen name="ConsumerUsernameSignUp" component={ConsumerUsernameSignUp} />
        <Stack.Screen name="ConsumerPasswordSignUp" component={ConsumerPasswordSignUp} />
        <Stack.Screen name="ConsumerGenderSignUp" component={ConsumerGenderSignUp} />
        <Stack.Screen name="ConsumerInterests" component={ConsumerInterests} />
        <Stack.Screen name="ConsumerOnBoarding" component={ConsumerOnBoarding} />
        <Stack.Screen name="ConsumerOnBoardingWelcome" component={ConsumerOnBoardingWelcome} />
      </Stack.Navigator>
    );
  }
}
