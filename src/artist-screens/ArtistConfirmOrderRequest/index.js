      ...
      <ScrollView>
        ...
        <View style={styles.orderContainer}>
          ...
          <View style={{marginRight: 10}}>
            <Text style={{color: '#1583D8', fontSize: 12}}>
              Total amount inc val
            </Text>
        ...
        <View style={styles.timeContainer2}>
          ...
          <TouchableOpacity
            onPress={() => handleTimePress('20m')}
            style={[styles.time, getTimeStyles('20m')]}>
            <Text>20m</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => handleTimePress('40m')}
            style={[styles.time, getTimeStyles('40m')]}>
            <Text>40m</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => handleTimePress('60m')}
            style={[styles.time, getTimeStyles('60m')]}>
            <Text>60m</Text>
          </TouchableOpacity>
        </View>

        <View style={styles.bookingNotes}>
          <Text style={{color: '#67718C', fontFamily: fonts.hk_bold}}>
            BOOKING NOTES:
          </Text>
