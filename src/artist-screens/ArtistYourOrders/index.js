      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: heightToDp(30) }}>
        ...
        <View
          ...
          <TouchableOpacity
            style={{
              width: widthToDp(21),
              backgroundColor: tab === 'All' ? '#84668C' : theme.background,
            ...
            <Text
              style={{
                ...
                fontSize: 16,
                color: tab === 'All' ? theme.background : theme.darkBlue,
              }}>
              {'All'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            onPress={() => setTab('On-going')}>
            <Text
              style={{
                fontFamily: fonts.robo_bold,
                fontSize: 16,
                color: tab === 'On-going' ? theme.background : theme.darkBlue,
              }}>
              {'On-going'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <Text
              style={{
                fontFamily: fonts.robo_bold,
                fontSize: 16,
                color: tab === 'Complete' ? theme.background : theme.darkBlue,
              }}>
              {'Complete'}
            </Text>
          </TouchableOpacity>
