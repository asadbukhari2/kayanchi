...
const ConsumerPaymentDetails = props => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.straightRow}>
        ...
        <Text
          style={[
            styles.chargesTxt,
            {color: theme.green, marginRight: widthToDp(6.7)},
          ]}>
          {'-80'}
        </Text>
      </View>
      <TouchableOpacity style={styles.straightRow}>
        <Text style={[styles.titleTxt, {color: theme.linkTxt}]}>
          {'Add promo'}
        </Text>
      </TouchableOpacity>
      ...
      <Text style={[styles.subTitle, {marginTop: heightToDp(9)}]}>
      ...
      <View style={styles.centerView}>
          ...
          <View style={[styles.straightRowInner,{marginTop:heightToDp(4.5)}]}>
            ...
            {sufficientBallance && (<Text style={[styles.chargesTxt, {color:theme.green,marginLeft:widthToDp(6.7)}]}>{'Pkr 1000'}</Text>)}
            </View>
            <ToggleSwitch
            isOn={walletPayment}
            onColor={theme.primary}
          ...
          <Text style={[styles.titleTxt,{marginLeft:0,marginTop:heightToDp(6.7),marginBottom:heightToDp(7.5)}]}>Use card</Text>
          <View>
            {
              DATA.map((item,index)=>{
                return(
          ...
          <TouchableOpacity
            activeOpacity={0.7}
            style={[styles.straightRow, styles.addAddress]}>
            <AntDesign
              name={'plus'}
              style={[styles.icon, {color: theme.lightBlack}]}
            />
            <Text style={styles.radioTxt}>{'Add new card'}</Text>
          </TouchableOpacity>
      </View>
      <Button title={'Continue'} btnStyle={{position:'absolute',bottom: heightToDp(5.5)}} onPress={() => props.navigation.navigate('OrderConfirm')} />
    </SafeAreaView>
  );
};

export default ConsumerPaymentDetails;
