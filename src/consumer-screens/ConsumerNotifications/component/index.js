...
const index = props => {
  ...
  return (
    <View style={[styles.container,{backgroundColor: unRead ? theme.primary : theme.background}]}>
      ...
      <View>
        <Text style={[styles.txt, {fontFamily: fonts.robo_bold,color: unRead ? theme.background : theme.backIcon}]}>{title}</Text>
        <Text style={[styles.txt, {fontFamily: fonts.robo_reg,color: unRead ? theme.background : theme.backIcon}]}>{body}</Text>
      </View>
      {unRead && (
        <TouchableOpacity style={styles.viewDetails}>
          <Text
            style={[
              styles.txt,
              {fontFamily: fonts.robo_reg, color: theme.background},
            ]}>
            {'View details'}
          </Text>
        </TouchableOpacity>
