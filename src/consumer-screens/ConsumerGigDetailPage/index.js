    ...
    <SafeAreaView style={styles.container}>
     ...
     <Text
        ...
        <View
          ...
          Say goodbye to unwanted marks and embrace smooth, flawless skin. Our
          skilled professionals utilize state-of-the-art technology and safe
          procedures to effectively diminish scars, stretch marks, and other
          imperfections.
        </Text>
        <View style={styles.separator}></View>
