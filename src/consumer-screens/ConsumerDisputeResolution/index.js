...
const ConsumerDisputeResolution = props => {
        ...
        {selectedQuestion !== null && (
          <View style={{ paddingHorizontal: widthToDp(4), marginTop: 10 }}>
            <TextInput
              ...
              style={styles.input}
            />
            <Text style={{ color: '#29AAE2', textAlign: 'right' }}>0/200</Text>
          </View>
        )}
...
export default ConsumerDisputeResolution;
...
const styles = StyleSheet.create({
  ...
  refund: { color: '#ABABAB', fontSize: 12, textAlign: 'center', marginVertical: 15 },
